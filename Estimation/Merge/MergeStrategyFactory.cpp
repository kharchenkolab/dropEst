...
namespace Merge
{
	...
	{
		auto main_config = config.get_child("config.Merge", boost::property_tree::ptree());
		...
		auto poisson_config = config.get_child("config.PreciseMerge", boost::property_tree::ptree());
