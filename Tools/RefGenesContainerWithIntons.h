...
namespace Tools
{
	class RefGenesContainerWithIntrons
	{
	...
	private:
		...
		typedef std::unordered_map<std::string, std::unordered_map<std::string, std::pair<pos_t, pos_t>>> transcript_positions_map_t;
	...
	public:
		RefGenesContainerWithIntrons();
		RefGenesContainerWithIntrons(const std::string &genes_filename);
