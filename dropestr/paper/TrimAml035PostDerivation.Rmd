...
```{r}
raw_corrected_rpus <- CorrectUmiSequenceErrorsClassic(reads_per_umi_per_cell$reads_per_umi, mult=1, mc.cores=30)
```
...
#                     classifier, trimmed$correction.info$dp.matrices, trimmed$correction.info$neighb.prob.index, 
#                     trimmed$collisions.info)
# 
# rpus_filt <- mclapply(trimmed$reads.per.umi.per.cb[f_inds], FilterUmisInGene, umi_probabilities_map,
#                       classifier, trimmed$correction.info$dp.matrices, trimmed$correction.info$neighb.prob.index, 
#                       trimmed$collisions.info, mc.cores=30)
# 
...
rpus_filt <- CorrectUmiSequenceErrorsBayesian(trimmed$reads.per.umi.per.cb, trimmed$umi.probabilities,
                                              trimmed$collisions.info, trimmed$correction.info, 
                                              distribution.smooth=50, quality.quants.num=15, mc.cores=30)
```
...
r0 <- FilterUmisInGene(gene0, umi_probabilities_map, classifier, trimmed$correction.info$dp.matrices, 
                       trimmed$correction.info$neighb.prob.index, trimmed$collisions.info, verbose=T)
```

```{r}
pv <- profvis(r0 <- FilterUmisInGene(gene0, umi_probabilities_map, classifier, trimmed$correction.info$dp.matrices, 
                                     trimmed$correction.info$neighb.prob.index, trimmed$collisions.info, verbose=T))
```
