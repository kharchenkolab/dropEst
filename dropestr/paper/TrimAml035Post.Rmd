...
# ggexport(supp_fig_errors, filename=paste0(kPlotsFolder, '/SuppFigureErrors.pdf'), pdf.height=10, pdf.width=8.3)
```
...
ggplot(plot_df, aes(x=GeneSize)) + 
  geom_line(aes(y=NumOfAdjacentUMIs / GeneSize^2, color='Bootstrap')) + 
  geom_line(aes(y=NumOfAdjacentUMIsUnif / GeneSize^2, color='Uniform'))
```
