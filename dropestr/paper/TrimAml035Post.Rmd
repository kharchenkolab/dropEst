...
trimmed <- TrimAndCorrect(reads_per_umi_per_cell, umi.trim.length=6, collisions.adj.step=20, mc.cores.large=20, mc.cores.small=10, verbosity.level=2, prepare.only=F)
```
